...
export const PACKAGES = [
  {
    ...
    price: "149",
    savings: "وفر 40 ريال",
    summary: "الخيار الأسرع للحجز إذا كنت تريد بداية قوية بسعر أخف وتوفير واضح من أول زيارة",
    features: ["30 دقيقة مساج", "حمام مغربي", "سفرة للجسم", "جلسة بخار"],
  },
  {
    name: "التوازن الراقي",
    badge: "الأكثر مبيعًا",
    ...
    price: "179",
    savings: "وفر 50 ريال",
    summary: "أكثر باقة متوازنة لمن يريد وقتًا أريح وخدمات إضافية مع توفير ممتاز",
    features: ["45 دقيقة مساج", "حمام مغربي", "حمام كريم", "سفرة للجسم", "جلسة بخار"],
  },
  {
    name: "الصفوة VIP",
    badge: "أفضل قيمة",
